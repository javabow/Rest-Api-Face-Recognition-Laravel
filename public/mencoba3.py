...
#Toleransi untuk tingkat kekeliruan dalam pendeteksian
tolerance = 0.5
...
#END Point
#end point check matkul jam sekarang
URL = 'https://www.javabow.com/laravel/api/matakuliah/'+hari+'/'+current_time
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                # print(url_check_krs)
                # check_krs = requests.get(url_check_krs, headers=headers)
                #
                # print(check_krs.json())
    ...
    video_capture.set(cv2.CAP_PROP_BUFFERSIZE, 6);
